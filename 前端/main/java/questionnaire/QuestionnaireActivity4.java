...
public class QuestionnaireActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        button1 = findViewById(R.id.fenhui2);
        radio1= findViewById(R.id.gender24);
        radio2= findViewById(R.id.gender25);
        radio3= findViewById(R.id.gender26);
        radio4= findViewById(R.id.gender27);
        radio5= findViewById(R.id.gender28);
        radio6= findViewById(R.id.gender29);
        radio7= findViewById(R.id.gender30);
        radio8= findViewById(R.id.gender31);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if((radio1.getCheckedRadioButtonId()==-1||radio2.getCheckedRadioButtonId()==-1)||(radio3.getCheckedRadioButtonId()==-1||radio4.getCheckedRadioButtonId()==-1
                    ...
                    Toast.makeText(QuestionnaireActivity4.this,"请完成问卷",Toast.LENGTH_LONG).show();
                }else{

                    Intent intent = new Intent(QuestionnaireActivity4.this, QuestionnaireActivity5.class);
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
//                Intent intent1 = new Intent(Test4.this,Test3.class);

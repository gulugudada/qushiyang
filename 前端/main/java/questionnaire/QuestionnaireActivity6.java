...
public class QuestionnaireActivity6 extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        button1 = findViewById(R.id.fenhui4);
        radio1= findViewById(R.id.gender39);
        radio2= findViewById(R.id.gender40);
        radio3= findViewById(R.id.gender41);
        radio4= findViewById(R.id.gender42);
        radio5= findViewById(R.id.gender43);
        radio6= findViewById(R.id.gender44);
        radio7= findViewById(R.id.gender45);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if((radio1.getCheckedRadioButtonId()==-1||radio2.getCheckedRadioButtonId()==-1)||(radio3.getCheckedRadioButtonId()==-1||radio4.getCheckedRadioButtonId()==-1
                    ...
                    Toast.makeText(QuestionnaireActivity6.this,"请完成问卷",Toast.LENGTH_LONG).show();
                }else{

                    Intent intent = new Intent(QuestionnaireActivity6.this, QuestionnaireActivity7.class);
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
//                Intent intent1 = new Intent(Test6.this,Test5.class);

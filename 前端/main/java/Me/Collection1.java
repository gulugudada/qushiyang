...
import com.hnucm.qushiyang.homepage.SeasonMore1_Activity;
...
public class Collection1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_collection1, container, false);
        ...
        x.http().post(requestParams, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                recycler6.setAdapter(myAdapter);
                recycler6.setLayoutManager(new LinearLayoutManager(getActivity()));
            }
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            xiangqing.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(getActivity(), CookbookMassage.class);

...
public class QuestionnaireActivity8 extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        button1 = findViewById(R.id.fenhui6);
        radio1= findViewById(R.id.gender53);
        radio2= findViewById(R.id.gender54);
        radio3= findViewById(R.id.gender55);
        radio4= findViewById(R.id.gender56);
        radio5= findViewById(R.id.gender57);
        radio6= findViewById(R.id.gender58);
        radio7= findViewById(R.id.gender59);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if((radio1.getCheckedRadioButtonId()==-1||radio2.getCheckedRadioButtonId()==-1)||(radio3.getCheckedRadioButtonId()==-1||radio4.getCheckedRadioButtonId()==-1
                    ...
                    Toast.makeText(QuestionnaireActivity8.this,"请完成问卷",Toast.LENGTH_LONG).show();
                }else{

                    Intent intent = new Intent(QuestionnaireActivity8.this, QuestionnaireActivity9.class);
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
//                Intent intent1 = new Intent(Test8.this,Test7.class);

...
public class QuestionnaireActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        button1 = findViewById(R.id.fenhui1);
        radio1= findViewById(R.id.gender16);
        radio2= findViewById(R.id.gender17);
        radio3= findViewById(R.id.gender18);
        radio4= findViewById(R.id.gender19);
        radio5= findViewById(R.id.gender20);
        radio6= findViewById(R.id.gender21);
        radio7= findViewById(R.id.gender22);
        radio8= findViewById(R.id.gender23);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if((radio1.getCheckedRadioButtonId()==-1||radio2.getCheckedRadioButtonId()==-1)||(radio3.getCheckedRadioButtonId()==-1||radio4.getCheckedRadioButtonId()==-1
                    ...
                    Toast.makeText(QuestionnaireActivity3.this,"请完成问卷",Toast.LENGTH_LONG).show();
                }else{

                    Intent intent = new Intent(QuestionnaireActivity3.this, QuestionnaireActivity4.class);
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
//                Intent intent1 = new Intent(Test3.this,Test2.class);

...
public class Collection3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_collection3, container, false);
        recycler8 = view.findViewById(R.id.recycler8);
        ...
        x.http().post(requestParams, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                try {
                    ...
                    JSONArray jsonArray = jsonObject1.getJSONArray("drug");
                ...
                recycler8.setAdapter(myAdapter);
                recycler8.setLayoutManager(new LinearLayoutManager(getActivity()));
            }
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            xiangqing.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("ChineseName",cookbook.getText().toString());
